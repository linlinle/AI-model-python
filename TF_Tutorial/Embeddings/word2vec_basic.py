...
# Step 3: Function to 生成训练样本 for the skip-gram Re_classifying.
...
# Step 4: Build and train a skip-gram Re_classifying.
...
# displaying Re_classifying accuracy, they don't affect calculation.
