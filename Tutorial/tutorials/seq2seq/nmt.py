...
from Tutorial.tutorials.seq2seq import inference
from Tutorial.tutorials.seq2seq import train
from Tutorial.tutorials.seq2seq.utils import evaluation_utils
from Tutorial.tutorials.seq2seq.utils import misc_utils as utils
from Tutorial.tutorials.seq2seq.utils import vocab_utils
...
def add_arguments(parser):
  ...
  parser.add_argument("--attention", type=str, default='scaled_luong',
  ...
  parser.add_argument(
      "--num_train_steps", type=int, default=1000, help="Num steps to train.")
  ...
  # data
  parser.add_argument("--src", type=str, default='vi',  #**change
                      help="Source suffix, e.g., en.")
  parser.add_argument("--tgt", type=str, default='en',  #**change
                      help="Target suffix, e.g., de.")
  parser.add_argument("--train_prefix", type=str, default='/tmp/tensorflow/nmt/data/train',    #**change
                      help="Train prefix, expect files with src/tgt suffixes.")
  parser.add_argument("--dev_prefix", type=str, default='/tmp/tensorflow/nmt/data/tst2012',
                      help="Dev prefix, expect files with src/tgt suffixes.")
  parser.add_argument("--test_prefix", type=str, default='/tmp/tensorflow/nmt/data/tst2013',
                      help="Test prefix, expect files with src/tgt suffixes.")
  parser.add_argument("--out_dir", type=str, default='D:/tmp/tensorflow/nmt/attention_model',
                      help="Store log/model files.")

  # Vocab   #**change
  parser.add_argument("--vocab_prefix", type=str, default='/tmp/tensorflow/nmt/data/vocab',
  ...
  parser.add_argument("--inference_input_file", type=str, default=None,#'D:/tmp/my_infer_file.txt',
  ...
  parser.add_argument("--inference_output_file", type=str, default=None,#'/tmp/tensorflow/nmt_model/output_infer',
