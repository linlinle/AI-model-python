...
from SL_Tutotial.logisticRegression import LR_Base
...
def stocGradAscent0(dataMatrix, classLabels):
    ...
    for j in range(500):
        for i in range(m):
            h = LR_Base.sigmoid(sum(dataMatrix[i] * weights))
...
def stocGradAscent1(dataMatrix, classLabels):
    ...
    for j in range(40):
        ...
        for i in range(m):
            ...
            h = LR_Base.sigmoid(sum(dataMatrix[randIndex] * weights))
...
dataMat,labelMat=LR_Base.load_dataset()
