...
def train_and_eval():
  ...
  est.fit(x=mnist.train.images, y=mnist.train.labels.astype(np.int64),
  ...
  results = est.score(x=mnist.test.images, y=mnist.test.labels.astype(np.int64),
                      batch_size=FLAGS.batch_size,
                      metrics=metric)
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default='D:/tmp/tensorflow/mnist/logs/random_forest',
