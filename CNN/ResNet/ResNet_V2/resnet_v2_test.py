...
import CNN.ResNet.resnet_utils as resnet_utils
...
class ResnetUtilsTest(tf.test.TestCase):
  ...
  def _resnet_plain(self, inputs, blocks, output_stride=None, scope=None):
    """A plain ResNet_V2 without extra layers before or after the ResNet_V2 blocks."""
  ...
  def _stack_blocks_nondense(self, net, blocks):
    """A simplified ResNet_V2 Block stacker without output stride control."""
    for block in blocks:
...
class ResnetCompleteNetworkTest(tf.test.TestCase):
  """Tests with complete small ResNet_V2 v2 networks."""
  ...
  def _resnet_small(self,
    ...
    """A shallow and thin ResNet_V2 v2 for faster tests."""
    block = resnet_v2.resnet_v2_block
    blocks = [
